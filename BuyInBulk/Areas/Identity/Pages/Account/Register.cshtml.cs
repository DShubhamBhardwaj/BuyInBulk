...
namespace BuyInBulk.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new()
            {
                ...
                CompanyList = _workContext.Company.GetAll().Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Role == CommonConstants.Role_Company)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, CommonConstants.Role_Customer);
                    }
                    ...
                    {
                        if (User.IsInRole(CommonConstants.Role_Admin))
                        {
